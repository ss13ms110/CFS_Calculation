...
c     work space
c
      integer*4 i,istp,j,l,n,ly,lup,lmd,llw,key
      real*8 zup,zlw
      complex*16 ck
      complex*16 b(6,4),cy(6,4)
      complex*16 yup(6,3),ylw(6,3)
      complex*16 ma0(6,6),c0(6,3),coef(6,6)
      complex*16 b3(3,4),coef3(3,3)
      complex*16 yup0(6,3),ylw0(6,3)
c
      ck=dcmplx(k,0.d0)
c
c===============================================================================
...
c
      call psgproppsv(maup,maiup,lp,lup,lmd,yup,yup0,k)
c
c===============================================================================
c
...
c
      call psgproppsv(malw,mailw,lp,llw,lmd,ylw,ylw0,k)
c
c===============================================================================
c
...
c
      ...
      if(key.eq.0)then
        print *,'warning in pegpsv: anormal exit from cdsvd500!'
        nwarn=nwarn+1
        return
      endif
      if(lzrec.lt.ls)then
